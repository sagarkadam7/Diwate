...
export const metadata: Metadata = {
  title: "Dining | Diwate Hospitality",
  description: "Choose a resort to view its dining experiences and photos.",
};

export default function DiningPickerPage() {
  return (
    <>
      <div className="pt-28 sm:pt-36 pb-16 sm:pb-24 px-5 sm:px-6 text-center bg-forest text-ivory">
        ...
        <p className="text-sm sm:text-base text-ivory/70 font-light max-w-xl mx-auto">
          Select a property below to explore its dining spaces and experiences.
        </p>
      </div>
